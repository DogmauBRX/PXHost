        ...
        {entries.length === 0 ? (
          <div className="flex flex-col gap-3">
            <ChatBubble
              role="assistant"
              serverId={serverId}
              blocks={[{ type: 'text', text: 'Oi! Sou o assistente GX 🤖 Posso ajudar com o dia a dia do seu servidor — instalar mods/plugins, backups, configurações e mais. O que você quer fazer?' }]}
            />
