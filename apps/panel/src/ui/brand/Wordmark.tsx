/**
 * "GXhost" with a continuously sweeping gradient shine — the `.brand-wordmark`
...
export function Wordmark({ className = '' }: { className?: string }) {
  return <span className={`brand-wordmark font-bold tracking-tight ${className}`}>GXhost</span>;
}
