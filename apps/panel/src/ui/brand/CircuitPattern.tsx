      ...
      <defs>
        <pattern id={id} width="72" height="72" patternUnits="userSpaceOnUse">
          <path
            ...
            fill="none"
            stroke="var(--circuit-accent, var(--color-accent))"
            strokeOpacity="0.55"
            strokeWidth="1"
          />
          <path
            ...
            strokeWidth="1"
          />
          <circle cx="36" cy="0" r="1.5" fill="var(--circuit-accent, var(--color-accent))" fillOpacity="0.6" />
          <circle cx="36" cy="72" r="1.5" fill="var(--circuit-accent, var(--color-accent))" fillOpacity="0.6" />
          <circle cx="0" cy="36" r="1.5" fill="var(--circuit-accent, var(--color-accent))" fillOpacity="0.6" />
          <circle cx="72" cy="36" r="1.5" fill="var(--circuit-accent, var(--color-accent))" fillOpacity="0.6" />
          <circle cx="36" cy="20" r="1.3" fill="var(--circuit-accent, var(--color-accent))" fillOpacity="0.65" />
          <circle cx="36" cy="52" r="1.3" fill="var(--circuit-accent, var(--color-accent))" fillOpacity="0.65" />
          <circle cx="22.14" cy="36" r="1.3" fill="var(--circuit-accent, var(--color-accent))" fillOpacity="0.65" />
          <circle cx="49.86" cy="36" r="1.3" fill="var(--circuit-accent, var(--color-accent))" fillOpacity="0.65" />
        </pattern>
      </defs>
