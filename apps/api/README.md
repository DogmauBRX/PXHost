...
> removed once the real payments integration (`src/modules/payments/`, see
> `docs/payments/mercadopago.md`) replaced it as the actual payment pipeline —
...
> exactly what the Mercado Pago webhook and billing-cycle job call today. Left
